...
var registerDefaultLayoutLoaders = __name(() => {
  registerLayoutLoaders([
    {
      name: "dagre",
      loader: __name(async () => await import("./dagre-6UL2VRFP-6H7PPOOO.js"), "loader")
    },
    ...true ? [
      {
        name: "cose-bilkent",
        loader: __name(async () => await import("./cose-bilkent-S5V4N54A-HGWJOQB5.js"), "loader")
      }
    ] : []
  ]);
...
//# sourceMappingURL=chunk-ZCY5H2VV.js.map

...
var _excluded = ["fileName", "fileType", "disabled", "blobUrl"];
...
var DownloadButton = /*#__PURE__*/memo(function (_ref) {
  var _ref$fileName = _ref.fileName,
    ...
    fileType = _ref$fileType === void 0 ? 'svg' : _ref$fileType,
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 2:
            _context.prev = 2;
            _context.next = 5;
            return downloadBlob(blobUrl, "".concat(fileName.replace(/\.[^./]+$/, ''), ".").concat(fileType));
          case 5:
            _context.next = 10;
            break;
          case 7:
  ...
  return /*#__PURE__*/_jsx(ActionIcon, _objectSpread(_objectSpread({
    title: "Download ".concat(fileType.toUpperCase())
  }, rest), {}, {
    icon: Download,

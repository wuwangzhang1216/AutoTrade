...
var _excluded = ["className", "itemMinWidth", "footer", "form", "items", "children", "itemsType", "itemVariant", "variant", "classNames", "styles", "gap", "style", "collapsible", "defaultActiveKey", "initialValues", "activeKey", "onCollapse", "onFinish", "ref", "layout"];
...
var Form = /*#__PURE__*/memo(function (_ref) {
  ...
  var mapFlat = useCallback(function (item, itemIndex) {
    return /*#__PURE__*/_jsx(FormItem, _objectSpread({
      className: classNames === null || classNames === void 0 ? void 0 : classNames.item,
      divider: itemIndex !== 0,
      minWidth: itemMinWidth,
      style: customStyles === null || customStyles === void 0 ? void 0 : customStyles.item,
      variant: variant
    }, item), itemIndex);
  }, [itemMinWidth, variant, classNames, customStyles]);
  var mapTree = useCallback(function (group, groupIndex) {
    ...
    return /*#__PURE__*/_jsx(FormGroup, {
      ...
      className: classNames === null || classNames === void 0 ? void 0 : classNames.group,
      ...
      style: customStyles === null || customStyles === void 0 ? void 0 : customStyles.group,
      styles: customStyles,
      title: group.title,
  ...
  }, [activeKey, collapsible, defaultActiveKey, _onCollapse, variant, classNames, customStyles]);

...
export var useStyles = createStyles(function (_ref, _ref2) {
  ...
  var placement = _ref2.placement,
    ...
    time = _ref2.time;
  var blockStylish = css(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n      padding-block: 8px;\n      padding-inline: 12px;\n      border: 1px solid ", ";\n      border-radius: ", "px;\n\n      background-color: ", ";\n    "])), rgba(token.colorBorderSecondary, 0.66), token.borderRadiusLG, token.colorBgContainer);
  var rawStylish = css(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n      padding-block-start: ", ";\n    "])), title ? 0 : '6px');
  var rawContainerStylish = css(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n      margin-block-end: -16px;\n      transition: background-color 100ms ", ";\n    "])), token.motionEaseOut);
  var typeStylish = variant === 'bubble' ? blockStylish : rawStylish;
  var editingStylish = editing && css(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n        width: 100%;\n      "])));
  return {
    actions: cx(css(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n          flex: none;\n          align-self: ", ";\n          justify-content: ", ";\n        "])), variant === 'bubble' ? 'flex-end' : placement === 'left' ? 'flex-start' : 'flex-end', placement === 'left' ? 'flex-end' : 'flex-start'), editing && css(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n            pointer-events: none !important;\n            opacity: 0 !important;\n          "])))),
    ...
    container: cx(variant === 'docs' && rawContainerStylish, css(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n          position: relative;\n\n          width: 100%;\n          max-width: 100vw;\n          padding-block: 24px 12px;\n          padding-inline: 12px;\n\n          time {\n            display: inline-block;\n            white-space: nowrap;\n          }\n\n          div[role='menubar'] {\n            display: flex;\n          }\n\n          time,\n          div[role='menubar'] {\n            pointer-events: none;\n            opacity: 0;\n            transition: opacity 200ms ", ";\n          }\n\n          &:hover {\n            time,\n            div[role='menubar'] {\n              pointer-events: unset;\n              opacity: 1;\n            }\n          }\n\n          ", " {\n            padding-block-start: ", ";\n            padding-inline: 8px;\n          }\n        "])), token.motionEaseOut, responsive.mobile, variant === 'docs' ? '16px' : '12px')),
    editingContainer: cx(editingStylish, css(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n          padding-block: 8px 12px;\n          padding-inline: 12px;\n          border: 1px solid ", ";\n\n          &:active,\n          &:hover {\n            border-color: ", ";\n          }\n        "])), token.colorBorderSecondary, token.colorBorder), variant === 'docs' && css(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n            border-radius: ", "px;\n            background: ", ";\n          "])), token.borderRadius, token.colorFillQuaternary)),
